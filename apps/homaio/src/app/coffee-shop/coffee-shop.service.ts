import {
  CoffeeShopService as CoffeeShopSmithyService,
  CoffeeType,
  CreateOrderServerInput,
  CreateOrderServerOutput,
  GetMenuServerInput,
  GetMenuServerOutput,
  GetOrderServerInput,
  GetOrderServerOutput,
  OrderNotFound,
  OrderStatus,
} from '@homaio/smithy-api';
...
export class CoffeeShopService
  implements CoffeeShopSmithyService<CoffeeShopContext>
{
  async CreateOrder(
    input: CreateOrderServerInput,
    context: CoffeeShopContext
  ): Promise<CreateOrderServerOutput> {
  ...
  async GetMenu(
    input: GetMenuServerInput,
    context: CoffeeShopContext
  ): Promise<GetMenuServerOutput> {
    ...
    return {
      items: [
        ...
        },
        {
          ...
          description:
            'A high-extraction and chilled form of coffee that has been cold-pressed..\n' +
  ...
  async GetOrder(
    input: GetOrderServerInput,
    context: CoffeeShopContext
  ): Promise<GetOrderServerOutput> {
  ...
  async handleOrders(context: CoffeeShopContext) {
    ...
    while (true) {
      ...
      const order = context.queue.shift();
      if (order != null) {
